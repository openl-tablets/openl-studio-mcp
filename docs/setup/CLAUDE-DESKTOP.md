...
**Important:** Replace `<path-to-project>` with your actual project path. See [Path Determination](#path-determination) section below.
...
**Important:**
- Replace `<path-to-project>` with your actual project path. See [Path Determination](#path-determination) section below.
...
pwd
# Output example: /Users/username/projects/openl-studio-mcp
# Use: /Users/username/projects/openl-studio-mcp/dist/index.js
```
...
# Get the absolute path
pwd
# Output example: C:\Users\username\projects\openl-studio-mcp
# Use: C:\Users\username\projects\openl-studio-mcp\dist\index.js
```

**VS Code/Cursor:**
- Use `$(workspaceFolder)` variable if supported
- Or right-click the project folder → "Copy Path" → append `/dist/index.js`
...
3. Ensure `OPENL_BASE_URL` ends with `/rest` (not `/rest/` - trailing slash is incorrect)
