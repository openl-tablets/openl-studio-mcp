...
import { sanitizeError, openBrowser, generateAuthorizationUrl, generateCodeVerifier, generateCodeChallengeSync, performOAuthFlowWithBrowser, isLocalhostRedirect, hashFingerprint } from "./utils.js";
      ...
      async (error) => {
        ...
        if (
          ...
          try {
            ...
            // Clear auth headers flag and existing Authorization header so interceptor re-runs
            delete (originalRequest as any)._authHeadersAdded;
            if (originalRequest.headers) {
              delete originalRequest.headers[HEADERS.AUTHORIZATION];
