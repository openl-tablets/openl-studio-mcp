...
**Important:** 
- Replace `<path-to-project>` with your actual project path (e.g., `/Users/yourname/projects/openl-studio-mcp`)
- Replace `<your-pat-token>` with your actual Personal Access Token from OpenL Tablets UI
...
2. **Check project path:**
   ```bash
   ls <path-to-project>/dist/index.js
   ```
   File should exist
